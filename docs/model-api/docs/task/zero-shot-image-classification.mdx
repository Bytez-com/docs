...
description: Classify images into categories not seen during training for applications like novel object recognition, transfer learning, and few-shot learning
icon: 'file-image'
mode: 'wide'
---
